...
каталог в родительском каталоге назначения. Для Atomic после успешных проверок он
переименовывается в финальный каталог назначения; в остальных случаях библиотека удаляет
временный каталог при завершении операции.
