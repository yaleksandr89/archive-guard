...
Atomic после успешных проверок переименовывает временный каталог в финальный каталог назначения.
При ошибке до публикации библиотека удаляет временный каталог. Merge удаляет временный каталог
